  ...
  return (
    <>
      ...
      <section id="form" className="flex flex-col justify-center lg:flex-row lg:justify-center">
          ...
          <div id="name-email-input" className="flex flex-col lg:justify-center lg:flex-row lg:space-x-4">
                <input id="name" type="text" placeholder="Name" className="w-full rounded-full lg:w-1/2 px-4 py-2 border border-gray-300 lg:rounded-md focus:ring-1 focus:outline-none"/>
                <input id="email" type="email" placeholder="E-mail" className="w-full rounded-full lg:w-1/2 mt-4 md:mt-0 px-4 py-2 border border-gray-300 lg:rounded-md focus:ring-1 focus:outline-none"/>
          </div>

          <div id="text-area" className="w-full">
            <textarea name="" id="text-area" rows="4" placeholder="Message" class="w-full rounded-2xl placeholder:pl-3 mt-4 lg:w-full lg:placeholder:pl-0 lg:mt-0 lg:px-4 lg:py-2 border border-gray-300 lg:rounded-md focus:ring-1 focus:outline-none" ></textarea>
          </div>
          <div id="btn-contact" className="flex w-full">
            <button type="submit" class="w-full rounded-full mt-4 font-bold bg-[#B47AEA] text-white py-3 px-6 mb-12 lg:mt-0 lg:rounded-md lg:hover:bg-purple-600 focus:outline-none">
                    Send message
            </button>
          </div>
